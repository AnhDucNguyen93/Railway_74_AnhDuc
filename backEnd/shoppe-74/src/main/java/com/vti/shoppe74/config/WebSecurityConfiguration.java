package com.vti.shoppe74.config;

import com.vti.shoppe74.config.exception.JwtRequestFilter;
import com.vti.shoppe74.service.impl.AccountSerivce;
...
// Config những API phải có Authority là ADMIN hoặc User thì mới được truy cập
                ...
                .anyRequest().authenticated()// Những đường dẫn còn lại cần được xác thực authenticated/permitAll
